...
public class SimpleTransactionTests {
	...
	public void simpleTransactionTest() {
		Transaction tx = SimpleTransaction.builder().merkleHash("0x00").blockHeight(0L).from("0x00").to("0x00")
				.speedy("000000000000000000000").maxSpeedy("000000000000000000000").value("000000000000001000000")
				.data(null).build();

		// data check
		assertEquals(tx.getBlockHeight(), 0L);
